...
class CommandeProvider extends ChangeNotifier {
  ...
  Commande? get commandeDetail => _commandeDetail;
  ...
  Future<void> fetchCommandes({
    ...
    try {
      ...
      final data = await _service.fetchCommandes(
        statut: statut,
      );
  ...
  Future<void> fetchCommandeDetail(
    ...
    try {
      ...
      final data = await _service.fetchCommandeDetail(
        commandeId,
      );
      ...
      _commandeDetail = Commande.fromJson(data);
  ...
  Future<Commande?> createCommandeFromPanier({
    ...
    try {
      ...
      final data = await _service.createCommandeFromPanier(
  ...
  Future<bool> updateCommandeStatut({
    ...
    try {
      ...
      final data = await _service.updateCommandeStatut(
        commandeId,
        statut,
      );

      final commande = Commande.fromJson(data);
  ...
  Future<bool> annulerCommande(
    ...
    try {
      ...
      final data = await _service.annulerCommande(
        commandeId,
      );
  ...
  Future<void> fetchPaiement(
    ...
    try {
      ...
      _paiement = await _service.fetchPaiement(
        commandeId,
      );
  ...
  Future<bool> createPaiement({
    ...
    try {
      ...
      _paiement = await _service.createPaiement(
